...
flirt -in $2  -ref $elecReconPath/T1.nii.gz -out $elecReconPath/postT1INpreT1.nii.gz -omat $elecReconPath/post2preT1.mat -interp trilinear -cost mutualinfo -dof 6 -searchcost normcorr -searchrx -180 180 -searchry -180 180 -searchrz -180 180
